...
gitdir="http://github.com/xmiah0906"
myblog="https://www.facebook/dreamon.jsilver"

cat << EOF

${c00}▉▉  | 
${c08}  ▉▉| ${c15}OS ${f0}........... $f2$system
${c01}▉▉  | ${c15}name ${f0}......... $f2$USER
${c09}  ▉▉| ${c15}birth day${f0}..... $f2$birthd
${c02}▉▉  | ${c15}packages ${f0}..... $f2$pkgnum
${c10}  ▉▉| 
${c03}▉▉  | ${c15}wm ${f0}........... $f2$wmname
${c11}  ▉▉| ${c15}shell ${f0}........ $f2$SHELL
${c04}▉▉  | ${c15}terminal ${f0}..... $f2$TERM
${c12}  ▉▉| ${c15}term font ${f0}.... $f2$termfn
${c05}▉▉  | 
${c13}  ▉▉| ${c15}kernel ${f0}....... $f2$kernel
${c06}▉▉  | ${c15}processor ${f0}.... $f2$cpuspe
${c14}  ▉▉| 
${c07}▉▉  | ${c15}facebook ${f0}..... $f2$myblog
