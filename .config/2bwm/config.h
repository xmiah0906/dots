...
static const uint8_t offsets[] = {7,7,14,19};
///---Colors---///
...
static const char *termcmd[] = {"urxvtc", "-geometry", "60x35", NULL };
static const char *stcmd[]   = {"xst", NULL };
...
//    {  MOD ,              XK_period,     changescreen,      {.i=TWOBWM_PREVIOUS_SCREEN}},
   ...
   // Start programs
    ...
    {  MOD |SHIFT,        XK_Return,          start,             {.com = stcmd}},
